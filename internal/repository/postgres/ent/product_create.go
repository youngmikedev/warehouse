...
func (pc *ProductCreate) SetArticle(s string) *ProductCreate {
	pc.mutation.SetArticle(s)
	return pc
}
...
func (pc *ProductCreate) check() error {
	...
	if _, ok := pc.mutation.Article(); !ok {
		return &ValidationError{Name: "article", err: errors.New(`ent: missing required field "Product.article"`)}
	}
...
func (pc *ProductCreate) createSpec() (*Product, *sqlgraph.CreateSpec) {
	...
	if value, ok := pc.mutation.Article(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
