...
type GetUserOK struct {
	...
	/*
	  In: Body
	*/
	Payload *models.UserUser `json:"body,omitempty"`
}
...
func (o *GetUserOK) WithPayload(payload *models.UserUser) *GetUserOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user o k response
func (o *GetUserOK) SetPayload(payload *models.UserUser) {
	o.Payload = payload
}
...
func (o *GetUserNotFound) WithPayload(payload string) *GetUserNotFound {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user not found response
func (o *GetUserNotFound) SetPayload(payload string) {
	o.Payload = payload
}
...
/*GetUserInternalServerError error message
...
func (o *GetUserInternalServerError) WithPayload(payload string) *GetUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get user internal server error response
func (o *GetUserInternalServerError) SetPayload(payload string) {
	o.Payload = payload
}
